...
import { createEntityNode, createLogicalAttribute, createLogicalEntity, createRelationship, createRelationshipEdge, createSystemDiagram } from '../../src/language-server/util/ast-util.js';
...
describe('CrossModelLexer', () => {
    ...
    describe('Serialize entity', () => {
        let crossModelRoot;
        let crossModelRootWithoutAttributes;
        let crossModelRootWithAttributesDifPlace;
        beforeAll(() => {
    ...
    describe('Serialize entity with inheritance', () => {
        ...
        test('Inheritance Cycle', async () => {
            ...
            expect(newCustomer.$document.diagnostics).toEqual(expect.arrayContaining([
...
const expected_result5 = `systemDiagram:
    ...
    edges:
      - id: Edge1
        ...
        sourceNode: A
        targetNode: B`;
//# sourceMappingURL=cross-model-serializer.test.js.map