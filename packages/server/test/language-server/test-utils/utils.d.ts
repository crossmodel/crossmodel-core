...
import { CrossModelRoot, DataModel, LogicalEntity, Mapping, Relationship, SystemDiagram } from '../../src/language-server/generated/ast.js';
...
export declare function parseSemanticRoot<T extends SemanticRoot>(input: DocumentInput, assert: ParseAssert, guard: TypeGuard<T>): Promise<WithDocument<T>>;
